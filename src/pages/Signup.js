	...
	return (
		<ThemeProvider theme={theme}>
			<div className='signup-page'>
				...
				>
					<div className='cranac'>Register into the community</div>
				</div>
				<Link
					to='/signin'
					style={{ position: 'absolute', zIndex: 1, top: '30px', left: '30px' }}
				>
				...
				<div className='signup-inner'>
					...
					>
						...
						<ol>
							<li>
								For Clubs Enter the name which comes before @daiict.ac.in in
								club email address
								<br />
								Club Email format : club_name@daiict.ac.in
								<br />
								You have to only enter <b>club_name</b> in Club ID section
							</li>
							<li>
								Please enter valid details in order to maintain consistency and
								harmony
							</li>
							<li>
								If account details are found to be invalid then that account
								shall be suspended indefinetly
							</li>
						</ol>
					</div>
					<form className={classes.root} autoComplete='off'>
						<label htmlFor='dp'>
							...
							>
								...
								>
									...
									<Avatar
										src={img}
										style={{ margin: '20px', height: '150px', width: '150px' }}
									/>
								</div>
							</div>
						</label>
						<div className={classes.inputRow} style={{ alignItems: 'center' }}>
							<FormControl component='fieldset'>
								<FormLabel
									style={{ color: 'white', fontSize: '20px', margin: 'auto' }}
									component='legend'
								>
