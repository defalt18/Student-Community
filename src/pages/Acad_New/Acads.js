	...
	return (
		...
		>
			<div className='rec__head'>
				<div className='left__rec'>
					<h1 style={{ fontSize: '60px', lineHeight: 1 }}>
						All the tools right on your screen
					</h1>
					<p style={{ fontSize: '20px' }}>
						{' '}
						So here we welcome you to the <b>Academics Page</b> which offers a
						compact view to all the resources an institute as well as the
						student community has to offer!. Dive in and enjoy the journey...
						<p>
							<a
								href='#rest_rec'
								style={{
									color: 'rgba(0,155,250)',
									margin: '10px 0',
									textDecoration: 'none'
								}}
							>
					...
					>
						<a
							href='https://forms.gle/Lpx3RXgrUR2U2eoA7'
			...
			<div id='rest_rec'>
				<Rexit
					name='Books'
					text='Tired of finding the pdfs online. Well have a look at this vault it may reduce the apparent tediousness!'
					image={Books}
				/>
				<Rexit
					name='Useful Links'
					text="Links to all the resource material and course pages where all the brewing happens!. Make sure you don't wander off!"
					image={Links}
				/>
				<Rexit
					name='Softwares'
					text='All the productivity tools provided to you by DA-IICT for free under the license of the institute. Use them wisely!'
					image={Softwares}
				/>
				<Rexit
					name='Videos'
					text='Short videos on the most crucial topics to help you through the last minute preparations!. Report if a link is broken'
					image={Videos}
				/>
