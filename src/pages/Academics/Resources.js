		...
		<div className='Reshome'>
			<div className='home__top'>
				...
				<div className='top__right'>
					<h2>Hóla people!</h2>
					<b>An institute</b> is judged and governed by the resources it can
					offer to the student community. Althrough it is pretty obvious that
					the students are the greatest resource of them all. But if great minds
					are provided with the best tools wonders can be achieved and no limits
					will persist. So here we welcome you to the <b>resources page</b>{' '}
					which offers a compact view to all the resources an institute as well
					as the student community has to offer!. Dive in and enjoy the
					journey...
					<p
						style={{
							cursor: 'pointer',
