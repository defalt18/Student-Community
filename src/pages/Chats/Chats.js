            ...
            <div className="chats">
                <div className="chat__left">
                    <div className="chat__top" style={{position:'sticky',top:0}}>
                        ...
                        <SearchIcon onClick={hideandseek} style={{padding:'0 10px',fontSize:'35px'}} />
                        </div>
                        <div id="search" style={{display:'none',width:'96%',marginTop:'5px'}}>
                            <input type="text" placeholder="Search Chats" style={{margin:'0',width:'100%',padding:'5px'}}/>
                        </div>
                    </div>
                    <div className="chat__rest" style={{
