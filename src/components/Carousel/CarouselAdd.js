	...
	var items = [
		{
			...
			src: 'https://yt3.ggpht.com/ytc/AAUvwng71nnss9wW79kbO35zj3YRbAlT-evasGXSHVrn7w=s900-c-k-c0x00ffffff-no-rj'
		},
		{
			name: 'Quantum Computing',
			description: 'Register here!',
			src: 'https://firebasestorage.googleapis.com/v0/b/da-student-connect.appspot.com/o/images%2Feventa.jpeg?alt=media&token=43a7028f-7a07-4271-a235-e51f56ea427b'
		}
		// {
		//     src:
