    ...
    var items = [
        {
            ...
            src:
                'http://20.185.220.79:8081/gallery/07.jpg',
        },
        {
            // name: 'DA-IICT',
            description: 'A place to be!',
            src:
                'https://educationiconnect.com/wp-content/uploads/2020/05/DAIICT-University-Fee-Structure-2020-2021.jpg',
        },
        {
            name: 'DA-IICT',
            description: 'A culture, a vibrance and an intellect',
            src:
                'https://images.shiksha.com/mediadata/images/1492513341php1FIK5E.jpeg',
        },
    ];
...
function Item(props) {
    return (
        <div className="caroMin" id="caro">
            <img className="carimg" src={props.item.src} alt="" style={{objectFit:'contain'}}/>
